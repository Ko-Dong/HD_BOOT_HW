...
import com.boothw.webapp.security.handler.ClubLoginSuccessHandler;
import com.boothw.webapp.security.service.OAuth2UserDetailsService;
...
//   }//configure AM
   ...
   protected void configure(HttpSecurity http) throws Exception {
       ...
       //로그 아웃 세팅
       http.logout().deleteCookies("JSESSIONID").logoutUrl("/logout").logoutSuccessUrl("/board/list");
