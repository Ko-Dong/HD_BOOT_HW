...
public class Pager {
	...
	private int totalRows; // 전체 행
	private int totalPageNo; // 전체 페이지
	private int totalGroupNo; // 전체 그룹 수
	private int startPageNo; // 그룹 시작 페이지 번호
	private int endPageNo; // 그룹 끝 페이지 번호
	private int pageNo; // 현재 페이지 번호
	private int pagesPerGroup; // 그룹당 페이지 수
	private int groupNo; // 현재 그룹 번호
	private int rowsPerPage; // 페이지당 행 수
	private int startRowNo; // 페이지 시작 행 번호 ( 1페이지 부터)
	private int startRowIndex; // 페이지 인덱스 번호 ( 0 부터 )
	private int endRowNo;// 페이지 마지막 행 번호
	private int endRowIndex; // 페이지 마지막 행 인덱스
